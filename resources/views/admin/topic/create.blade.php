                ...
                <div class="col-lg-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Add Topic</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name_topic" class="form-control" placeholder="Enter Your Topic Name">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="tags-default">
                                                <input type="text" name="tag_name" data-role="tagsinput" placeholder="add tags" /> 
